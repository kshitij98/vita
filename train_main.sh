...
echo "Using ${TRAIN} for training"

DATA=${DATADIR}/preprocessed
SRC=en_XX
TGT=hi_IN
NAME=en-hi
DEST=${DATADIR}/postprocessed/final
CHALLENGE_DEST=${DATADIR}/postprocessed/final_challenge

langs=ar_AR,cs_CZ,de_DE,en_XX,es_XX,et_EE,fi_FI,fr_XX,gu_IN,hi_IN,it_IT,ja_XX,kk_KZ,ko_KR,lt_LT,lv_LV,my_MM,ne_NP,nl_XX,ro_RO,ru_RU,si_LK,tr_TR,vi_VN,zh_CN
POSTPROCESSED=${DATADIR}/postprocessed/final/${NAME}
SAVEDIR=${DATADIR}/checkpoint/final

WARMUP=400 STEPS=8500 SAVE_FREQ=15000
...
--trainpref ${DATA}/${TRAIN}.spm \
--validpref ${DATA}/${VALID}.spm \
--testpref ${DATA}/${CHALLENGE}.spm  \
--destdir ${CHALLENGE_DEST}/${NAME} \
--thresholdtgt 0 \
--thresholdsrc 0 \
--srcdict ${DICT} \
--tgtdict ${DICT} \
